"""HTTP client for Google App Engine.

Support most tornado httpclient interface.
"""
import calendar
import email
import functools
...
class HTTPResponse(object):
    ...
    * time_info: dictionary of diagnostic timing information from the request.
    ...
    """
    def __init__(self, request, code, headers={}, buffer=None, body=None,
